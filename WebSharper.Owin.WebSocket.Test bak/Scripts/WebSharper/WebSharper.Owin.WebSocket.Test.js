...
{
 "use strict";
 var Global,WebSharper,Owin,WebSocket,Test,Client,WebSharper$Owin$WebSocket$Test_JsonEncoder,WebSharper$Owin$WebSocket$Test_JsonDecoder,Html,Client$1,Tags,Concurrency,$,Utils,Client$2,WithEncoding,JSON,IntelliFactory,Runtime,Arrays,ClientSideJson,Provider;
 Global=self;
