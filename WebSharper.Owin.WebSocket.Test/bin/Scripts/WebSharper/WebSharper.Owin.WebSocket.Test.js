...
{
 "use strict";
 var Global,testFrom0,Client,GeneratedPrintf,WebSharper$Owin$WebSocket$Test_JsonEncoder,WebSharper$Owin$WebSocket$Test_JsonDecoder,WebSharper,Html,Client$1,Tags,Concurrency,Owin,WebSocket,Client$2,WithEncoding,JSON,IntelliFactory,Runtime,Utils,$,UI,Next,Var,Submitter,View,Remoting,AjaxRemotingProvider,Doc,AttrProxy,Strings,Arrays,ClientSideJson,Provider;
 Global=self;
  ...
  Concurrency.Start((b=null,Concurrency.Delay(function()
  {
   ...
   }),function(a)
   {
    ...
    },Concurrency.Delay(function()
    {
     ...
     {
      conn.send(JSON.stringify((WebSharper$Owin$WebSocket$Test_JsonEncoder.j())({
       $:2,
       $0:{
        name:{
         "first-name":"John00",
 ...
 Client.fsiCmd=function()
 {
  ...
  {
   var b;
   return a!=null&&a.$==1?(new AjaxRemotingProvider.New()).Async("WebSharper.Owin.WebSocket.Test:testFrom0.Server.fsiExecute:-1840423385",[a.$0]):(b=null,Concurrency.Delay(function()
   {
 ...
 {
  return WebSharper$Owin$WebSocket$Test_JsonDecoder._v?WebSharper$Owin$WebSocket$Test_JsonDecoder._v:WebSharper$Owin$WebSocket$Test_JsonDecoder._v=(Provider.DecodeUnion(void 0,"type",[["int",[["$0","value",Provider.Id(),0]]],["string",[["$0","value",Provider.Id(),0]]],["name",[["$0","value",Provider.Id(),0]]],["msgStr",[["$0","value",Provider.Id(),0]]]]))();
 };
}());
