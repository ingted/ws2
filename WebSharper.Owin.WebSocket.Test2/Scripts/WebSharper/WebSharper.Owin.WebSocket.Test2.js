...
{
 "use strict";
 var Global,WebSharper,Owin,WebSocket,Test,Client,WebSharper$Owin$WebSocket$Test2_JsonEncoder,WebSharper$Owin$WebSocket$Test2_JsonDecoder,Html,Client$1,Tags,Concurrency,$,Utils,Client$2,WithEncoding,JSON,IntelliFactory,Runtime,Arrays,ClientSideJson,Provider;
 Global=self;
 ...
 WebSharper$Owin$WebSocket$Test2_JsonEncoder=Global.WebSharper$Owin$WebSocket$Test2_JsonEncoder=Global.WebSharper$Owin$WebSocket$Test2_JsonEncoder||{};
 WebSharper$Owin$WebSocket$Test2_JsonDecoder=Global.WebSharper$Owin$WebSocket$Test2_JsonDecoder=Global.WebSharper$Owin$WebSocket$Test2_JsonDecoder||{};
 ...
 Client.WS=function(endpoint)
 {
  ...
  Concurrency.Start((b=null,Concurrency.Delay(function()
  {
   ...
   {
    return JSON.stringify((WebSharper$Owin$WebSocket$Test2_JsonEncoder.j())(a));
   },function(a)
   {
    return(WebSharper$Owin$WebSocket$Test2_JsonDecoder.j())(JSON.parse(a));
   },endpoint,function()
   {
    var b$1;
    b$1=null;
 ...
 WebSharper$Owin$WebSocket$Test2_JsonEncoder.j=function()
 {
  return WebSharper$Owin$WebSocket$Test2_JsonEncoder._v?WebSharper$Owin$WebSocket$Test2_JsonEncoder._v:WebSharper$Owin$WebSocket$Test2_JsonEncoder._v=(Provider.EncodeUnion(void 0,{
   "int":1,
   str:0
  },[["Request1",[["$0","str",Provider.EncodeArray(Provider.Id()),0]]],["Request2",[["$0","int",Provider.EncodeArray(Provider.Id()),0]]]]))();
 };
 WebSharper$Owin$WebSocket$Test2_JsonDecoder.j=function()
 {
  return WebSharper$Owin$WebSocket$Test2_JsonDecoder._v?WebSharper$Owin$WebSocket$Test2_JsonDecoder._v:WebSharper$Owin$WebSocket$Test2_JsonDecoder._v=(Provider.DecodeUnion(void 0,"type",[["int",[["$0","value",Provider.Id(),0]]],["string",[["$0","value",Provider.Id(),0]]]]))();
 };
}());
